...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    // Bakiye Yükleme Formu Gönderimini Yönet
    const topUpForm = document.getElementById("top-up-form");
    if (topUpForm) {
        topUpForm.addEventListener("submit", handleBalanceTopUp);
    }
});

// Diğer yerlerde kullanılacaksa global erişim için (opsiyonel)
window.openTopUpForm = openTopUpForm;
window.closeTopUpForm = closeTopUpForm;
